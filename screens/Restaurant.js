...
const Restaurant = ({ route, navigation }) => {
    ...
    return (
      ...
      >
        {restaurant?.menu.map((item, index) => (
          <View
            key={`menu-${index}`}
            style={{ alignItems: "center", backgroundColor: "#F8D521" }}
          >
  ...
  function renderDots() {
    ...
    return (
      <View style={{ height: 30, backgroundColor: "#F8D521" }}>
        <View
          style={{
            flexDirection: "row",
            alignItems: "center",
    ...
    return (
      <View style={{ backgroundColor: "#F8D521" }}>
        ...
        >
          ...
          >
            <Text style={{ ...FONTS.h3 }}>{getBasketItemCount()} Produits</Text>
            <Text style={{ ...FONTS.h3 }}>{sumOrder()} FCFA</Text>
          </View>
